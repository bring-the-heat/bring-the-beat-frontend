...
const SubmissionForm = () => {
    ...
    return (
        <FormContainer>
            ...
            <Form className="form" onSubmit={handleSubmit} method="POST" action="https://script.google.com/macros/s/AKfycbyLTeO6JeXeOae7gv84BPKBAMSyabeRUoiD68Suq2LfxLFHoBlAEcupV9SqsfnGfO9jWw/exec">
                <Input
                    type="text"
                    name="firstName"
